...
void loop() {
  ...
  if (pid_active) {
    ...
    // Format: L90,L45,F,R45,R90,sW_L90,sW_L45,sW_F,sW_R45,sW_R90,SteeringIn,PID_Out,L_Speed,R_Speed,BaseSpeed,CurSpeed
    ...
    Serial.print(baseSpeed); Serial.print(","); Serial.println(currentSpeed);
